...
{
  // layer 0 - QUERTY Mac (LALT and LGUI are swapped)
  {
  ...
  // arrows and media
  {
    ...
    { KC_NONE, KC_NONE,    KC_NONE,    KC_NONE,     KC_NONE,    KC_NONE,     KC_NONE,    KC_NONE,     KC_NONE,    KC_LEFT,     KC_DOWN, KC_RIGHT },
    { },
    { KC_NONE,    KC_NONE, KC_NONE, KC_NONE,  KC_NONE, KC_NONE, KC_NONE, KC_NONE,  KC_NONE, KC_NONE,  KC_LAYER_0, KC_LAYER_1, KC_MUTE, KC_ESCAPE }
  }
};
