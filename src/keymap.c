...
const keycode_t KEYMAP[KEYMAP_LAYERS][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
  // 0 - the regular
  {
    ...
    { KC_LCTRL,    KC_LGUI, KC_LALT, KC_NONE,  KC_NONE, KC_SPACE, KC_NONE, KC_NONE,  KC_NONE, KC_NONE,  KC_MUTE,   KC_ESCAPE,   KC_LAYER_0,  KC_LAYER_1 }
  },
  // 1 - arrows and media
  {
    { },
    { KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_UP },
    { KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_LEFT, KC_DOWN, KC_RIGHT, KC_ENTER },
    { },
    { KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_NONE, KC_MUTE, KC_ESCAPE, KC_LAYER_0, KC_LAYER_1 }
  }
};
